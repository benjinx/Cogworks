...
public class DeviceSpecificDisplay : MonoBehaviour
{
    ...
    public class DisplayData
    {
        ...
        public List<GameObject> objectsToDisplay = null;
    }
    ...
    private void InputDeviceChanged()
    {
        ...
        // Turn off all display data
        foreach (DisplayData displayData in deviceSpecificData)
        {
            foreach (GameObject gobj in displayData.objectsToDisplay)
            {
                if (gobj)
                {
        ...
        // Turn on the current ones we should turn on
        foreach (GameObject gobj in dataToDisplay.objectsToDisplay)
        {
            if (gobj)
            {
                gobj.SetActive(true);
